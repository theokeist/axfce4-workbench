...
static const gchar *MWB_CSS =
  ...
  "}"
  ".mwb-clear-bg .mwb-island, .mwb-clear-bg.mwb-island, .mwb-bar.mwb-clear-bg .mwb-island {"
  "  background: alpha(#000000, 0.35) !important;"
  "  border: 1px solid alpha(#ffffff, 0.16) !important;"
  "  border-radius: 6px !important;"
  "  box-shadow: 0 1px 3px alpha(#000000, 0.45) !important;"
  "}"
  ".mwb-clear-bg .mwb-button, .mwb-clear-bg .mwb-volbutton, .mwb-clear-bg .mwb-clockbtn, .mwb-clear-bg .mwb-clocks, .mwb-clear-bg .mwb-title {"
  "  color: #ffffff !important;"
  "  text-shadow: 0 1px 2px alpha(#000000, 0.9), 0 0 1px #000000 !important;"
  "}"
  ".mwb-theme-light .mwb-clear-bg .mwb-island, .mwb-theme-light.mwb-clear-bg .mwb-island, .mwb-theme-light .mwb-bar.mwb-clear-bg .mwb-island {"
  "  background: alpha(#ffffff, 0.45) !important;"
  "  border: 1px solid alpha(#000000, 0.18) !important;"
  "  border-radius: 6px !important;"
  "  box-shadow: 0 1px 3px alpha(#000000, 0.2) !important;"
  "}"
  ".mwb-theme-light .mwb-clear-bg .mwb-button, .mwb-theme-light .mwb-clear-bg .mwb-volbutton, .mwb-theme-light .mwb-clear-bg .mwb-clockbtn, .mwb-theme-light .mwb-clear-bg .mwb-clocks, .mwb-theme-light .mwb-clear-bg .mwb-title {"
  "  color: #1e293b !important;"
  "  text-shadow: 0 1px 0 alpha(#ffffff, 0.8) !important;"
  "}"
  "";
